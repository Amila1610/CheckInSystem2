...
@NamedQueries({
    ...
    @NamedQuery(name = "Employee.findByUsernameAndPassword", query = "SELECT e FROM Employee e WHERE e.username=:username AND e.password = :password"),
...
public class Employee implements Serializable {
    ...
    public Employee(Integer id, String username, String password, String name, String surname) {
        this.id = id;
